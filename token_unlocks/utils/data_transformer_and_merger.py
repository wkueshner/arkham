...
def process_and_merge_csvs(source_folder, merged_folder):
    ...
    merged_file_path = os.path.join(merged_folder, 'featurized_merged.csv')
    merged_df.to_csv(merged_file_path, index=False)
    
    print(f'All data processed and merged into {merged_file_path}.')

# Define the source and destination folder paths
source_folder = 'unlocks_standardized1'
merged_folder = 'merged'

# Process and merge all CSV files into one
process_and_merge_csvs(source_folder, merged_folder)
